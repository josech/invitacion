...
function MapaHome(){
    ...
    const titleMap="myMapHome";

    return (
      <div className="conte-mapa">
        <iframe src={scrMapHome} width={widthMap} height={heightMap} padding={paddingMap} loading={loadingMap} scrolling={scrollingMap} title={titleMap}>
        </iframe>
      </div>
    )
}
