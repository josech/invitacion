...
function Mapa(){
    ...
    const titleMap="myMapCeremonia";

    return (
      <div className="conte-mapa">
        <iframe src={scrMap} width={widthMap} height={heightMap} padding={paddingMap} loading={loadingMap} scrolling={scrollingMap} title={titleMap}>
        </iframe>
      </div>
    )
}
